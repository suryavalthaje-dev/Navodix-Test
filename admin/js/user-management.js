(function () {
  ...
  const state = { users: [], currentUser: null, currentAdmin: null, editingUser: null };
  ...
  async function handleCreateUser(event) {
    ...
    if (!displayName || !email || !role) { showMessage('Please complete Display Name, Email Address and Role.', 'error'); return; }
