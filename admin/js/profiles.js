(function(){
  ...
  let currentPage = 1;
  const PAGE_SIZE = 20;
  let profiles = [], requirement = null, requirements = [], jobCategories = [], saving = false, keepExistingResume = true, selectedExistingResume = false, allExistingProfiles = [], profileToAssociate = null, interviewProfile = null, interviewSaving = false, profileAssociationProfileId = '', profileAssociationEditId = '';
  ...
  async function openProfileAssociationModal(profileId, associationId=''){
    ...
    $('profileAssociationSaveButton').innerHTML=associationId
  ...
  async function saveProfileAssociation(){
    ...
    const btn=$('profileAssociationSaveButton'); btn.disabled=true;
